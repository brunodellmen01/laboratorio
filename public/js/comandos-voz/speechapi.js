...
window.addEventListener('DOMContentLoaded', function(){
  ...
  var dominio = 'https://www.labsystem.net.br/demo/public/';
  ...
  if(window.SpeechRecognition || window.webkitSpeechRecognition){
    ...
    recebe_audio.onresult = function(event){
      ...
      for(var i = event.resultIndex; i < event.results.length; i++){
          ...
          if (resultado.toLowerCase() === "paciente") {
              window.location.href = dominio+'paciente';
              
          }

          if (resultado.toLowerCase() === "ver paciente") {
               window.location.href = dominio+'paciente/listar';
              
          }
         

          if (resultado.toLowerCase() === "agenda") {
               window.location.href = dominio+'agenda';             
              
          }

          if (resultado.toLowerCase() === "sair") {
          ...
          if (resultado.toLowerCase() === "home") {
              window.location.href = dominio+'home';             
              
          }

          if (resultado.toLowerCase() === "inicio") {
              window.location.href = dominio+'home';             
              
          }

          if (resultado.toLowerCase() === "caixa") {
               window.location.href = dominio+'financeiro/caixa';             
              
          }

          if (resultado.toLowerCase() === "novo pedido") {
               window.location.href = dominio+'pedido';             
              
          }

          if (resultado.toLowerCase() === "ver pedido") {
               window.location.href = dominio+'pedido/listar';
              
          }

          if (resultado.toLowerCase() === "internos") {
               window.location.href = dominio+'pedidos/internos';
              
          }

          if (resultado.toLowerCase() === "externos") {
              window.location.href = dominio+'pedidos/externos';
              
          }

          if (resultado.toLowerCase() === "aniversariantes") {
              window.location.href = dominio+'relatorios/aniversariantes';
              
          }

          if (resultado.toLowerCase() === "usuário") {
              window.location.href = dominio+'usuarios';
              
          }

          if (resultado.toLowerCase() === "atualizar") {
              window.location.reload();             
              
          }

          if (resultado.toLowerCase() === "voltar") {
              window.history.back();          
