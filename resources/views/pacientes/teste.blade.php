		        	...
		        	<div class="col-md-3">
	                    <div class="ibox-content text-center">
	                	    ...
	                	    <div class="m-b-sm">
	                	    	...
	                	    	<img src="http://localhost:8000/images/uploads/profile/12/phpUtRtvr.jpeg" width="96" height="96" class="img-circle"  data-toggle="tooltip" data-placement="top" title="{{$inativo->name}}">
	                        ...
	                        <p class="font-bold">{{$inativo->city->name}}</p>
	                        <div class="text-center">
	                            <a href="../ativar/{{$inativo->id}}" class="btn btn-xs btn-white"" data-toggle="tooltip" data-placement="bottom" title="Ativar / Inativar {{$inativo->name}}"><i class="fa fa-unlock-alt"></i>  </a>
	                            <a href="../{{$inativo->id}}/editar" class="btn btn-xs btn-white" data-toggle="tooltip" data-placement="bottom" title="Editar {{$inativo->name}}"><i class="fa fa-pencil"></i> </a>
	                            <a href="../{{$inativo->id}}/editar" class="btn btn-xs btn-white" data-toggle="tooltip" data-placement="bottom" title="Editar {{$inativo->name}}"><i class="fa fa-pencil"></i> </a>
	                        </div>
		                </div>
	                </div>
