...
@section('content')
<title>Cadastro de Métodos</title>
<div class="container">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">
                    Cadastro de Métodos
                    <a href="{{ url('/metodo/listar') }}" class="pull-right">Listar Métodos</a>
                </div>
                ...
                <div class="panel-body">
                    ...
                    @if(Request::is('*/editar'))
                        {!! Form::model($method, ['method' => 'PATCH', 'url' => 'metodo/'.$method->id.'/editar']) !!}
                    @else
                        {!! Form::open(['url' => 'metodo/salvar']) !!}
                    @endif
