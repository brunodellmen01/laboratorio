        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <a href="{{ url('material/listar') }}" class="pull-right">Listar Materiais</a>
                </div>
                ...
                <div class="panel-body">
                    ...
                    @if(Request::is('*/editar'))
                        {!! Form::model($material, ['method' => 'PATCH', 'url' => 'material/'.$material->id.'/editar']) !!}
                    @else
                        {!! Form::open(['url' => 'material/salvar']) !!}
                    @endif
