        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">
                    Lista de Materiais
                    <a href="{{ url('material/novo') }}" class="pull-right">Novo material</a>
                </div>
                        ...
                        <table class="table" id="myTable">
                            ...
                            <tbody>
                                @foreach($materiais as $material)
                                  <tr>
                                    <td class="pull-left">{{ $material->name }}</td>
                                    <td>
                                        <a href="../material/{{$material->id}}/editar" class="btn btn-info btn-md"><span class="glyphicon glyphicon-pencil" alt="Editar"  title="Editar"></span></a>
                                    </td>
                                   <td>
                                        {!! Form::open(['method' => 'POST', 'url' => '/material/'.$material->id.'/inativar']) !!}
